...
class Jog extends React.Component {
    ...
    render() {
        return (
            ...
            <span className="badge badge-default badge-warn" title="Items in Queue" id="syncstatus" style={{marginRight: 5}}>Socket Closed</span>
                    ...
                    <td colSpan="5">
                          <div id="controlmachine" className="btn-group" role="group" aria-label="controljob">
                            <div className="btn-group">
                                <button id="homeAll" type="button" className="btn btn-ctl btn-default">
                                    <span className="fa-stack fa-1x">
                            ...
                            <div className="btn-group">
                                <button id="playBtn" type="button" className="btn btn-ctl btn-default">
                                    <span className="fa-stack fa-1x">
                            ...
                            <div className="btn-group">
                                <button id="uploadBtn" type="button" className="btn btn-ctl btn-default" style={{display: 'none'}}>
                                    <span className="fa-stack fa-1x">
                            ...
                            <div className="btn-group">
                                <button id="stopBtn" type="button" className="btn btn-ctl btn-default">
                                    <span className="fa-stack fa-1x">
                            ...
                            <div className="btn-group">
                                <button id="zeroAll" type="button" className="btn btn-ctl btn-default">
                                    <span className="fa-stack fa-1x">
                            ...
                            <div className="btn-group">
                                <button id="bounding" type="button" className="btn btn-ctl btn-default">
                                    <span className="fa-stack fa-1x">
