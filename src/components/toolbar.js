...
class Toolbar extends React.Component {
    ...
    constructor(props) {
        super(props);
        let {comMachines, comInterfaces, comPorts, comAccumulatedJobTime} = this.props.settings;
        accumulatedJobTime = comAccumulatedJobTime;
        this.state = {comMachines: comMachines, comInterfaces: comInterfaces, comPorts: comPorts};
        let selectedMachine = this.props.settings.__selectedProfile || "";
    }
    ...
    refreshMachines() {
        ...
        if (profiles) {
            for (var i = 0; i < profiles.length; i++) {
                machines.push(profiles[i].machineDescription);
            }
            that.setState({comMachines: machines});
            dispatch(setSettingsAttrs({comMachines: machines}));
...
//        });
    ...
    handleConnectMachine() {
        ...
        var connectMachine = this.props.settings.connectMachine;
        //get connection settings from machine profile
    ...
    render() {
        ...
        return (
            <div id="toolbar">
                <FormControl componentClass="select" onChange={(e)=>{this.handleSelect(e)}} value={this.state.comMachine} ref="select" className="full-width">
